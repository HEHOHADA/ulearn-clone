...
import { codeDoReviewRequest, courseRequest, moduleRequest, testTaskRequest } from '../../shared/request'
...
export const mapFetchingData = new Map<any, any>([[courseRequest, 'course'],
    [moduleRequest, 'module'], [ThemeEnum, 'theme']])
...
export const fetchUserDataById = (request: fetchingDataById, id: any): BaseThunkType<ActionUserType> => async dispatch => {
    dispatch(userActions.setLoading())
    try {
