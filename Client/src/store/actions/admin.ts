...
export const addAdminDataWIthStore = (request: fetchingData, form: any): BaseThunkType<ActionAdminType> => async dispatch => {
    try {
...
export const updateAdminDataWithStore = (request: fetchingData, form: any, id: number): BaseThunkType<ActionAdminType> => async dispatch => {
    try {
...
export const removeAdminDataWithStore = (request: fetchingData, id: number): BaseThunkType<ActionAdminType> => async dispatch => {
    try {
