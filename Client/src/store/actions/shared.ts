...
export type fetchingData = typeof courseRequest | typeof groupRequestByUser | typeof subscriptionRequest
export type fetchingDataById = fetchingData | typeof moduleRequest |
    typeof videoTaskRequest | typeof codeTaskRequest
    | typeof testTaskRequest
export const mapFetchingData = new Map<string, any>([[courseRequest, 'courses'],
    [groupRequestByUser, 'groups'], [subscriptionRequest, 'subscriptions']])
...
export const fetchData = (request: fetchingData): BaseThunkType<ActionSharedType> => async dispatch => {
...
export const fetchDataById = (request: fetchingDataById, id: number): BaseThunkType<ActionSharedType> => async dispatch => {
    dispatch(sharedActions.setLoading())
    try {
