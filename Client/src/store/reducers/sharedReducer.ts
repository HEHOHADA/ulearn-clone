...
import { SET_ERROR, SHARED_FETCH_SUCCESS, SHARED_REMOVE_LOADING, SHARED_SET_LOADING } from '../actions/types'
...
export default (state = initialStateShared, action: ActionAdminType | ActionSharedType): InitialStateSharedType => {
    let newUpdatedData
