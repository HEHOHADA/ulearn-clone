...
const SubscriptionPage = React.lazy(() => import( '../modules/pages/Admin/Subscription/SubscriptionPage'))
const SubscriptionEdit = React.lazy(() => import( '../modules/pages/Admin/Subscription/SubscriptionEdit'))
const SubscriptionCreate = React.lazy(() => import(  '../modules/pages/Admin/Subscription/SubscriptionCreate'))
...
export const AdminRoute = () => {
    ...
    return (
        <Switch>
            ...
            <AppRoute exact path={ '/admin/course/:courseId/module/:moduleId/theme/create' } layout={ AdminLayout }
                      component={ ThemeCreate }/>
            <AppRoute exact path={ '/admin/course/:courseId/module/:moduleId/theme' } layout={ AdminLayout }
                      component={ ThemePage }/>
            <AppRoute exact path={ '/admin/course/:courseId/module/create' } layout={ AdminLayout }
                      component={ ModuleCreate }/>
            <AppRoute exact path={ '/admin/course/:courseId/module/edit/:moduleId' } layout={ AdminLayout }
                      component={ ModuleCreate }/>
            <AppRoute exact path={ '/admin/course/:courseId/module' } layout={ AdminLayout } component={ ModulePage }/>
            <AppRoute exact path={ '/admin/subscription/edit/:id' } layout={ AdminLayout }
                      component={ SubscriptionEdit }/>
            <AppRoute exact path={ '/admin/subscription/create' } layout={ AdminLayout }
